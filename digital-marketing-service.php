...
<section class="logo-container ">
    <div class="container-fluid  position-relative digital-header" data-aos="fade-up" data-aos-delay="100">
...
?>
<script>
  headerColor("black","#65b6df");    // $("#header").css("background-color","#78b9fac5");
