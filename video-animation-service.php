...
<section id="servicesdetails"  class="logo-container ">
    <div class="topheader container-fluid  position-relative pattern-header" data-aos="fade-up" data-aos-delay="100">
...
?>
<script>
  headerColor("rgb(17,17,17)","rgb(72,171,187)");    
</script>
<script>
    videoAnimationBackground();
