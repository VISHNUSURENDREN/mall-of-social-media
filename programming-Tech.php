    ...
    <div class="container-fluid position-relative"  data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1><span class="video">Programming</span><span class="and">&</span><span class="animation">Tech</span></h1>
          ...
          <div class="icon-box  index flip-box">
            <div class="flip-box-inner">
              ...
              <div class="flip-box-back">
                ...
                <a  href="" onclick="openHere(this,<?php echo $index?>,'programming-tech-service.php?service=<?php echo $service['mainheader']?>& id=<?php echo $service['service_id']?>'); return false;" title="more information"><i class="bx bx-plus"></i></a>
