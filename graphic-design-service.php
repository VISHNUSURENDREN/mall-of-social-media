...
<section id="servicesdetails" class="logo-container ">
    <div class="topheader container-fluid  position-relative logo-header" data-aos="fade-up" data-aos-delay="100">
...
?>
<script>
  headerColor("#45a29e","black");    // $("#header").css("background-color","#78b9fac5");
</script>